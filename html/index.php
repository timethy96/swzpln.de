...
<body>
    ...
    <div id="main">
        ...
        <div id="finish" class="hidden">
            ...
            <br/>
            <br/>
            <p>Wenn ihr uns bei der Instandhaltung und Entwicklung dieses Angebots, sowie bei den monatlich anfallenden Serverkosten unterstützen wollt, freuen wir uns natürlich sehr über eine Spende. <form action="https://www.paypal.com/donate" method="post" target="_top" style="width:86px;width:fit-content;margin:5px auto;display:block;"><input type="hidden" name="hosted_button_id" value="P3L3M55U4WBT8" /><input type="image" src="https://www.paypalobjects.com/de_DE/DE/i/btn/btn_donateCC_LG.gif" border="0" name="submit" title="PayPal - The safer, easier way to pay online!" alt="Donate with PayPal button" /><img alt="" border="0" src="https://www.paypal.com/de_DE/i/scr/pixel.gif" width="1" height="1" /></form></p>
