...
<body>
	...
	Die durch die Seitenbetreiber erstellten Inhalte, Werke und Code auf diesen Seiten unterliegen der <a href="https://opensource.org/licenses/AGPL-3.0" target="_blank">AGPL-3.0 - Lizenz</a>. Die Downloads werden Lizenzlos (<a href="https://creativecommons.org/publicdomain/zero/1.0/deed.de" target="_blank">CC0</a>) bereitgestellt, die Kartendaten stehen unter der <a href="https://osm.org/copyright" target="_blank">OpenStreetMaps-Lizenz</a>. Soweit die Inhalte auf dieser Seite nicht vom Betreiber erstellt wurden, werden die Urheberrechte Dritter beachtet. Insbesondere werden Inhalte Dritter als solche gekennzeichnet. Sollten Sie trotzdem auf eine Urheberrechtsverletzung aufmerksam werden, bitten wir um einen entsprechenden Hinweis. Bei Bekanntwerden von Rechtsverletzungen werden wir derartige Inhalte umgehend entfernen.<br><br><strong>Datenschutz</strong><br><br>
        Die Nutzung unserer Webseite ist ohne Angabe personenbezogener Daten möglich. Kein "wenn" und "aber". <br>
        ...
        <p>Used Libraries:<br/>
               <a href="https://jquery.com/" target="blank">jQuery</a>: MIT-License<br/>
               <a href="https://leafletjs.com/" target="blank">Leaflet-Map</a>: BSD2-License<br/>
               <a href="https://github.com/tyrasd/osmtogeojson" target="blank">osmtogeojson.js</a>: MIT-License<br/>
               <a href="https://github.com/gagan-bansal/geojson2svg" target="blank">geojson2svg.js</a>: MIT-License<br/>
               <a href="https://github.com/geosquare/reproject-spherical-mercator" target="blank">reproject-spherical-mercator.js</a>: MIT-License<br/>
               <a href="https://github.com/MrRio/jsPDF" target="blank">jsPDF</a>: MIT-License<br/>
               <a href="https://github.com/yWorks/svg2pdf.js" target="blank">svg2pdf</a>: MIT-License<br/>
        </p>
        <br/><br/><br/><br/>
    ...
    <script src='js/repoject-spherical-mercator.min.js'></script>
