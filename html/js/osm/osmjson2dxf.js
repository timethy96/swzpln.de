importScripts('./osmjson2objarray.js?v=1.0.0-rc2', '/js/osm/dxf.js?v=1.0.0-rc2');
//import { osmjson2objarray, deg2XY } from './osmjson2objarray.js?v=1.0.0-rc2'; //-> module webworkers not yet implemented in Firefox
