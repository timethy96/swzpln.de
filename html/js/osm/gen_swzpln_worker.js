//import { osmjson2dxf } from './osmjson2dxf.js?v=1.0.0-rc2'; //-> module webworkers not yet implemented in Firefox
...
onmessage = function(e) {
    ...
    if (layers.includes('contours')) {
        ...
        if (typeof Conrec === 'undefined') {
            importScripts('../conrec/conrec.js?v=1.0.0-rc2');
        }
